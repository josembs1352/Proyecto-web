                        ...
                        <div class="container">
                            <div class="table-responsive cart_info">
                                <table class="table table-condensed">
                                    ...
                                    $db = new dataBase();
                                    $db->conectar();
                                    $rec = $db->consultar("carrito", "id_usuario", $id_usuario);
                                    while ($row = mysqli_fetch_array($rec)) {
                                        $id_carrito = $row['0'];
                                        $id_usuarioC = $row['1'];
                                        $cancion_C = $row['2'];
                                        $canciones = $db->consultar("audio", "id_cancion", $cancion_C);
                                        while ($row = mysqli_fetch_array($canciones)) {
                                            $id_cancion = $row['0'];
                                            $id_usurio = $row['1'];
                                            $id_artista = $row['2'];
                                            $nombre = $row['3'];
                                            ...
                                            <form id = "nuevoUsuario" method = "post" action = "Control.php" >
                                                <td class="cart_total">
                                                    <button class="btn btn-danger btn-large" name="cancion_C" value="<?php echo $id_carrito ?>"><span class = "glyphicon glyphicon-trash" aria-hidden = "true"></span> Eliminar</button>
                                                </td>
                                            </form>
